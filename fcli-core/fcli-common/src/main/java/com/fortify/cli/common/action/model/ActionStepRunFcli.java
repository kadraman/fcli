...
public final class ActionStepRunFcli extends AbstractActionStep {
    ...
    @JsonProperty(value = "forEach", required = false) private ActionStepRunFcli.ActionStepFcliForEachDescriptor forEach;
