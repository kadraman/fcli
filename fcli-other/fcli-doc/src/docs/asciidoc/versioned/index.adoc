...
custom fcli actions. Please see the link:../v2.x-v3.x-migration.html[migration guide] for details.
...
* Actions developed for fcli 2.x will fail to run on fcli 3.x (see link:../v2.x-v3.x-migration.html[migration guide])
